...
(() => {
  ...
  var simpleGraph = /* @__PURE__ */ function() {
    ...
    })(newGraph(fromFoldable(ordInt)(foldableArray)([new Tuple(0, new Vec(100, 200)), new Tuple(1, new Vec(200, 200)), new Tuple(2, new Vec(200, 400))]))(fromFoldable3(foldableArray)(ordEdge(ordInt))([new Edge(0, 1), new Edge(1, 2), new Edge(2, 0)])));
  }();
  var getCanvas = function __do() {
    ...
    ;
    throw new Error("Failed pattern match at Main (line 40, column 3 - line 40, column 47): " + [v.constructor.name]);
  };
  var frameRate = 60;
  ...
  var colorz = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Main (line 43, column 1 - line 43, column 28): " + [v.constructor.name]);
  };
